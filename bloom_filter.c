...
// ������Ӧ���ȵ�����ǰ׺
			...
			{
//				calculate_Bloom_Filter(ht, lb_tp); //���������Ĳ�³ķ������
...
// BF����
	...
	//*************************************************************************
	//modify modify modify BF����
					for(int lb_i = 0; lb_i < HASH_TIME; lb_i++)//���ι�ϣ��Ӧbloom������λ�����Ƚ�
					{
						lb_temp++;
	...
	//end modify
	//*************************************************************************
				if((lb_time == lb_temp) && (lb_time <= HASH_TIME))                                      //BFƥ���ɹ����������ֲ���
				{
					lb_real++;
					lb_bf++;
					if(lb_real < BF_DEEP)
...
//BF����ϣ���ҽ���
			if((lb_flag !=0) && (lb_length == lb_middle))
				break;
			else if(lb_flag != 0)                                                            //��ϣ���ҳɹ�
				lb_low = lb_middle + 1;
			else if((lb_flag == 0) && (lb_bf != 0))                                        //��ϣ����ʧ�ܣ�BF���ҳɹ�
				lb_low = lb_middle + 1;
			else if((lb_flag == 0) && (lb_bf == 0))                                        //��ϣ����ʧ��, BF����ʧ��
				lb_high = lb_middle - 1;
